    ...
    public void selected(SelectionEvent ev)
        ...
        if (m_traceSelection) {
            ...
            if (ev.m_selection.getType() == ev.m_selection.CLASS_NODESET) {
                ...
                if (DTM.NULL == pos) {
                    m_pw.println("     [Could not find match for " + ev.m_attributeName + "=" + ev.m_xpath.getPatternString() + "]");
